...
class PCA_For_Stat_Arb(object):
    ...
    def LoadDataIntoTimeSeries(self,benchMarkIndex,stkUniverIndex,returnHorizon):
        ...
        self.retDf.to_csv('log_return.csv')
        self.retDf2.to_csv('pct_return.csv')
    ...
    def GenEigenPort(self,date,v,percentage,nSampleDate,outlier):
        ...
        eigVec = eig[1]
        pd.DataFrame(eigVec).to_csv('raw_eigen_vec.csv')
    ...
    def CalcEigenPortRet(self,startDate,endDate,winsorize):
        ...
        self.stkRetDf.to_csv("return_for_calc_eighen_port.csv")
    ...
    def RegressOnEigenFactor(self,date,nSampleDate,VolAdjPrice,winsorize=0):
        ...
        resiDf.to_csv("regress_risiduals.csv")
        #for stk in self.eigPortUniver:
        #    print stk 
    ...
    def OUFitAndCalcZScore(self,sampleDays,drift):
        ...
        self.regressResiduals.iloc[-sampleDays:].to_csv('residuals_for_ou.csv')
        self.regressResiduals.iloc[-sampleDays:].cumsum().to_csv('cum_reisiduals.csv')
